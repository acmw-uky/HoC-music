...
This is slightly more advanced code than easyBuzzer.ino. New things include arrays (int notes[] = {list of stuff}) and a for-loop (for (int index = 0; index < NumOfNotes; index++) {more lines of commands}).
